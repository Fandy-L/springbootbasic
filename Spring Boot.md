...
${random.int(10)}、${random.int[10624,65536]}
...
| 日志实现                                     | 日志门面  （日志的抽象层）                           |
| ---------------------------------------- | ---------------------------------------- |
| Log4j  JUL（java.util.logging）  Log4j2  **Logback** | ~~JCL（Jakarta  Commons Logging）~~    SLF4j（Simple  Logging Facade for Java）    **~~jboss-logging~~**~~JCL（Jakarta  Commons Logging）~~    SLF4j（Simple  Logging Facade for Java）    **~~jboss-logging~~** |
...
- Support for serving static resources, including support fo

- r WebJars (see below).静态资源文件夹路径,webjars
